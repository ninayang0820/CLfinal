...
let username = "user-" + (Date.now() + Math.floor(Math.random() * 10000));
...
send.addEventListener("click", () => {
  if (message.value) {
    ...
    bot.reply(username, message.value).then(function(reply) {
      console.log(reply)
      if (!reply.includes("No Reply")) {
        chatList.innerHTML += `
                <div class="messageItemReverse">
                    <p class="userName"><img src="./images/robot.png" style="width: 30px" /></p>
